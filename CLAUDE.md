...
- **Cold start** free tier หลายเจ้าพักแอปเมื่อไม่มีคนใช้ พอลูกบ้านทักไลน์ แอปต้องตื่นก่อนถึงตอบได้ ซึ่งอาจช้าเกิน timeout ของ LINE webhook แล้วข้อความแรกหาย ถ้าเจอปัญหานี้ให้ทำ health check ping ทุก 10 นาที หรือย้ายไปแพ็กเกจที่ไม่หลับ
- **โควตาพื้นที่** สลิปปีละประมาณ 15 MB ไม่น่ามีปัญหา แต่ต้องเช็คว่า free tier ให้เท่าไหร่
- **Backup** free tier ส่วนใหญ่ไม่มี backup ให้ ต้องตั้ง job ดัมพ์ฐานข้อมูล + สลิปขึ้น Google Drive เองทุกคืน
