...
- เก็บเลขมิเตอร์วันคืนห้องและวันรับห้องแยกจากรายเดือน หน่วยที่เพิ่มระหว่างห้องว่างจึงไม่ถูกคิดกับผู้เช่าคนเก่าหรือคนใหม่
...
- การนำเข้าผู้เช่าเดิมใช้เลขมิเตอร์ตั้งต้นที่บันทึกไว้ได้ และระบบจะไม่ออกบิลที่ขาดเลขมิเตอร์ของงวดก่อน
- ยกเลิกบิลที่ยังไม่มีการชำระยืนยัน แล้วแก้ข้อมูลและออกบิลงวดเดิมใหม่ได้
- ยกเลิกรายการรับเงินโดยเก็บหลักฐานเดิมไว้ พร้อมคำนวณสถานะบิลใหม่และป้องกันรับเงินเกินยอด
...
- ย้ายออก หักค่าน้ำ/ไฟ/หนี้/ค่าเสียหาย พร้อมรูปหลักฐาน, PDF แจกแจง และติดตามทั้งคืนมัดจำ/ยอดที่ผู้เช่ายังค้าง
...
- ส่งออกรายงาน CSV สำหรับบิล การรับเงิน มิเตอร์รายเดือน มิเตอร์วันรับ–คืนห้อง ผู้เช่า และการย้ายออก
...
# กู้ไฟล์ล่าสุดลงฐานทดสอบชั่วคราว ตรวจตารางหลัก แล้วลบทิ้งโดยไม่แตะฐานจริง
...
ควรใช้ปลายทาง backup คนละเครื่อง/ผู้ให้บริการและเก็บหลายรุ่นตามนโยบายของปลายทาง `verify-database-restore.sh` สร้างฐานชื่อ `RentalManagerRestoreCheck_*` ชั่วคราวแล้วลบทิ้ง ห้ามเปลี่ยนสคริปต์ให้ restore ทับฐานข้อมูลจริง
